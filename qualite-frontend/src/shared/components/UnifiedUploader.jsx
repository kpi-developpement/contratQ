...
// ENDPOINTS S7A7 M'SYNCRONISYIN M3A L'BACKEND DYALK
const API_ENDPOINTS_FICHIER_1 = {
  ...
  // HADO HOMA LES URLS LI 3NDK DB F L'CONTROLLERS:
  SAV_PERF: "/api/v1/excel/sav/perf",
  SAV_DELAI: "/api/v1/excel/sav/delai",
...
export default function UnifiedUploader() {
  ...
  const modules = {
    ...
    SAV_PERF: { id: 'SAV_PERF', label: 'SAV PERF', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg> },
    SAV_DELAI: { id: 'SAV_DELAI', label: 'SAV DÉLAI < 3J', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> },
    SECURISATION: { id: 'SECURISATION', label: 'SÉCURISATIONS', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg> },
    CCR: { id: 'CCR', label: 'CCR NON EXP', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> },
  ...
  const isFichier1Group = ["SACLI_OK", "SARCLI_NOK", "GEM_NOK", "TAUX_20J", "SAV_PERF", "SAV_DELAI", "SECURISATION", "CCR"].includes(activeModule);

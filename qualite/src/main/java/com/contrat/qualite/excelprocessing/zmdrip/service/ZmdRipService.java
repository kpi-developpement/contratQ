...
public class ZmdRipService {
    ...
    public ZmdRipResultDto processZmdRipExcel(MultipartFile file) {
        long num = 0;
        long denum = 0;
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(file.getInputStream(), StandardCharsets.UTF_8));
            ...
            if (targetCol == null) {
                throw new RuntimeException("Mala9inach l'colonne 'Taux de report TH' f l'fichier ZMD RIP.");
            }
        ...
        return ZmdRipResultDto.builder()
                .num(num)
                .denum(denum)
                .resultat(resultat)
                .partDeMarche(0.0)
